...
const config = {
  ...
  registration: {
    ...
    transportStations: ["Kashmiri Gate", "Sarai Kale Khan/ Nizamuddin", "Kalinidi Kunj", , "Sector 28 Faridabad","Inderprastha"],
  },
  ...
  // Shuttle service details — shown in the transport popup + footer section
  transport: {
    enabled: true,
    startsAt: "2:00 PM onwards",
    formUrl: "https://forms.gle/wQqZ9UomNutY1Hz46",
    pickupPoints: [
      { name: "Kashmere Gate Metro Station", coordinator: "Mr. Naresh Kumar", phone: "9813409611" },
      { name: "Sarai Kale Khan / Nizamuddin Metro Station", coordinator: "Mr. Dharmender Kumar", phone: "9911445066" },
      { name: "Kalindi Kunj Metro Station", coordinator: "Mr. Ritik Verma", phone: "8130427972" },
      { name: "Sector 28 Metro Station", coordinator: "Mr. Mahesh Adhana", phone: "9911757907" },
    ],
  },
