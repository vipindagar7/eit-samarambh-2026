...
const config = {
  ...
  registration: {
    ...
    transportStations: ["Kashmiri Gate","Sarai Kale Khan/ Nizamuddin","Kalinidi Kunj","Akshardham","Laxmi Nagar",,"Sector 28 Faridabad","Badarpur Border", "Badkal Mor","Lajpat Nagar","Sarita Vihar","Ashram"],
  },
